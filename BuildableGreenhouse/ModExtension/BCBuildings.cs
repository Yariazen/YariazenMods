...
namespace BuildableGreenhouse.ModExtension
{
	...
	{
		private static IBCBuildingsApi BCBuildingsApi;

		private static partial void BCBuildingsExtension()
		{
			Helper.Events.GameLoop.GameLaunched += registerGreenhouseBlueprint;
		}

		private static void registerGreenhouseBlueprint(object sender, GameLaunchedEventArgs e)
		{
			//Todo: No idea how to get a reference to SF blueprint
		}
	}
